					...
					<CardColumns className="cardsDeck">
						<Card className="projectCard" border="warning">
							...
							<Card.Body>
								...
								<Card.Text>
									A project to develop a Visual Studio Code extension to add the
									famous internet character Doge and his friends into the IDE
								</Card.Text>
							</Card.Body>
							<Card.Footer>
								<Button
						...
						<Card className="projectCard" border="warning">
							...
							<Card.Body>
								...
								<Card.Text>
									A project to build an online personal website as a portfolio
									for my entire work
								</Card.Text>
							</Card.Body>
							<Card.Footer>
